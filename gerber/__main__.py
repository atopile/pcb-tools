...
def main():
    ...
    parser.add_argument(
        "--backend",
        "-b",
        choices=available_renderers.keys(),
        default="cairo",
    ...
    parser.add_argument(
        "--theme",
        "-t",
        choices=theme.THEMES.keys(),
        default="default",
        help="Select render theme.",
    )
    parser.add_argument("--width", type=int, default=1920, help="Maximum width.")
    parser.add_argument("--height", type=int, default=1080, help="Maximum height.")
    parser.add_argument(
        "--verbose",
        "-v",
        action="store_true",
